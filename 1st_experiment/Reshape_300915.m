...
% x_max = max(updated_data(:,17));  for rectaungular
...
%% putting corresponding grid center
id_val_gcu=IDS;
...
for ii=1:length(id_val_gcu)
    ...
    if size(id_val_gcu{ii},1)~=0
        ...
        id_val_gcu{ii}(1,end+1)= Training_data{ii}(1,19);
        id_val_gcu{ii}(1,end+1)= Training_data{ii}(1,20);
    end
